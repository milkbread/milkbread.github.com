...
public class geotest3 extends PApplet {
...
public void draw() {
  ...
  x = PApplet.parseFloat(values[5]);                           // Retrieve x coordinate from 6th column
  y = PApplet.parseFloat(values[4]);                           // Retrieve y coordinate from 5th column  
  c = PApplet.parseFloat(values[6]);                          //Retrieve magnitude from 7th column --> it defines the point color
  m = PApplet.parseInt(values[1]);                            //Retrieve month
  d = PApplet.parseInt(values[2]);                            //Retrieve day
  ...
  if (mags == true){
    ...
    text(PApplet.parseInt(c),x,(c*10));  //write the value of the magnitude to the end of the rectangle
  }
...
public void printCoords(int val){
  int index = 0;
...
class Coords{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "geotest3" });
  }
}
